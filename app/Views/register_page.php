...
<body>
  ...
  <form action="" method="post" style="display: flex; flex-direction: column; width: 60%;">
    ...
    <input style="padding: 10px 20px;" type="text" placeholder="type your Full name" name="fullname" />
    ...
    <input style="padding: 10px 20px;" type="radio" name="gender" id="l" value="L" /><label for="l">MAN</label>
    <input style="padding: 10px 20px;" type="radio" name="gender" id="p" value="P" /><label for="p">Women</label>
